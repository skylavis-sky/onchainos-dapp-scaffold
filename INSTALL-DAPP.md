...
现在想把它放进 Claude Code 的 skills 目录，并准备用脚手架做 Onchain OS 集成。
...
2. 识别每个工具的业务类型
3. 按脚手架规范加 [Onchain OS 依赖] / [签名约束] / requiredTools / Pre-flight Checks
